...
angular.module('app')
   ...
   */
  .constant('JQ_CONFIG', {
    easyPieChart: ['vendor/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js'],
    sparkline: ['vendor/jquery.sparkline.bower/dist/jquery.sparkline.min.js'],
    ...
    vectorMap: ['vendor/jqvmap/dist/jquery.vmap.min.js',
                          'vendor/jqvmap/dist/maps/jquery.vmap.world.js',
